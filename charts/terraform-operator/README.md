...
![Version: v0.1.16](https://img.shields.io/badge/Version-v0.1.16-informational?style=flat-square) ![AppVersion: v0.3.9](https://img.shields.io/badge/AppVersion-v0.3.9-informational?style=flat-square)
...
| controller.image.tag | `string` tag of the image | `"v0.3.9"` |
