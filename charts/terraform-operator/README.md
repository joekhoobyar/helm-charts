...
![Version: v0.1.14](https://img.shields.io/badge/Version-v0.1.14-informational?style=flat-square) ![AppVersion: v0.3.7](https://img.shields.io/badge/AppVersion-v0.3.7-informational?style=flat-square)
...
| controller.image.tag | `string` tag of the image | `"v0.3.7"` |
